@extends('layouts.dashboard'){{-- mengarah ke --}}
@section('title'){{-- relasi ke yield extends --}}
    Store Dashboard Transaction Details Page
@endsection

@section('content'){{-- relasi ke yield extends --}}
<div
